...
> 
> Эффективность работы стратегии зависит от вашего провайдера, региона и оборудования ТСПУ/DPI. Данные параметры могут подходить не всем. Если у вас возникли проблемы со стабильностью подключения, **рекомендуется попробовать альтернативные стратегии из сборки Zapret**.
